...
prepare: mkdir mount pacman-sync pacman-base copy-pac pacman-extra mkinitramfs
...
clean: umount
	rm -rf --one-file-system boot root iso
...
pacman-base:
	...
	setarch $(ARCH) pacman --config ./conf/pacman.conf --root ./root -S kernel26
